...
import { ArrowDown, MoveDown, Settings } from "lucide-react";
        ...
        <Card className="py-3 rounded-2xl">
          <CardContent className="py-0">
            ...
            <div className="flex justify-between text-xs text-muted-foreground">
              ...
              <div>
                {tokenSelectedFrom && `balance : ${tokenSelectedFrom.balance}`}{" "}
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="py-3 rounded-2xl">
          <CardContent className="py-0">
            ...
            <div className="flex justify-between text-xs text-muted-foreground">
              ...
              <div>
                {tokenSelectedTo && `balance : ${tokenSelectedTo.balance}`}{" "}
              </div>
            </div>
          </CardContent>
        </Card>
